...
(function() {
    ...
    function init() {
        ...
        // Minimize button - completely hide chat and show toggle button
    ...
    async function sendMessage() {
        ...
        try {
            ...
            // Send to backend using XMLHttpRequest for better compatibility
            ...
            xhr.onreadystatechange = function() {
                if (xhr.readyState === 4) {
                    ...
                    if (xhr.status >= 200 && xhr.status < 300) {
                        ...
                        setTimeout(() => {
                            addMessage(xhr.responseText || "I didn't catch that. Could you please try again?", 'assistant');
                            isTyping = false;
                        }, 500);
                    } else {
                        // Add error message
